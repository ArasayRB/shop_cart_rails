...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post credit_cards_url, params: { credit_card: { cash: @credit_card.cash, cvv: @credit_card.cvv, expire: @credit_card.expire, number: @credit_card.number } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { cash: @credit_card.cash, cvv: @credit_card.cvv, expire: @credit_card.expire, number: @credit_card.number } }
