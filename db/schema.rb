...
ActiveRecord::Schema.define(version: 2021_10_07_164913) do
  ...
  create_table "item_lines", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "shopping_cart_payeds", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "shopping_cart_id"
    t.integer "user_id"
